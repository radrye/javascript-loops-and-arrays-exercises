...
var topChoices = ['eggs', 'panckes', 'cheerios','bagel and lox']; 
...
var firstChoice = topChoices[3];
var secondChoice = topChoices[0]; {
    console.log("My #1 choice is" + [3]);
}
}
*/
